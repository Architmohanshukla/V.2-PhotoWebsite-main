...
const galleries = {
    ...
    portrait: [
        { src: 'portrait/portrait1.webp', caption: 'Quiet Gaze' },
        { src: 'portrait/portrait2.webp', caption: 'Soft Smile' },
        { src: 'portrait/portrait3.webp', caption: 'Deep Eyes' },
        { src: 'portrait/portrait4.webp', caption: 'Bold Stare' },
        { src: 'portrait/portrait5.webp', caption: 'Gentle Soul' },
        { src: 'portrait/portrait6.webp', caption: 'Lost Thought' },
        { src: 'portrait/portrait7.webp', caption: 'Warm Light' },
        { src: 'portrait/portrait8.webp', caption: 'Shadow Play' },
        { src: 'portrait/portrait9.webp', caption: 'Timeless Face' },
        { src: 'portrait/portrait10.webp', caption: 'Silent Muse' },
        { src: 'portrait/portrait11.webp', caption: 'Fading Glow' },
        { src: 'portrait/portrait12.webp', caption: 'Inner Peace' },
        { src: 'portrait/portrait13.webp', caption: 'Golden Hour' },
        { src: 'portrait/portrait14.webp', caption: 'Raw Emotion' },
        { src: 'portrait/portrait15.webp', caption: 'Still Moment' }
    ],
    abstract: [
